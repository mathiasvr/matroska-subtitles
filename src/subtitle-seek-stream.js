...
// experimental (early) version of SubtitleStream that skips to ebml tag offsets by intercepting mkv seek and cue points
export class SubtitleSeekStream extends SubtitleParserBase {
  constructor () {
    super()
  ...
  seekTo (offset) {
    ...
    const newParser = new SubtitleSeekStream()
